...
TOKEN = '8569225701:AAHzf2epUvvOgH0vIKsZtK3Gp2CheVBkTHY'
ADMIN_ID = 7902065505 #ايدي
YOUR_USERNAME = '@sii_3k'
CHANNEL_USERNAME = '@VIP_636547'
...
def ask_to_upload_file(call):
    ...
    if free_mode or (user_id in user_subscriptions and user_subscriptions[user_id]['expiry'] > datetime.now()):
        ...
        bot.send_message(call.message.chat.id, "⚠️ يجب عليك الاشتراك لاستخدام هذه الميزة.")
...
def handle_file(message):
    ...
    if free_mode or (user_id in user_subscriptions and user_subscriptions[user_id]['expiry'] > datetime.now()):
        ...
        bot.reply_to(message, "⚠️ يجب عليك الاشتراك لاستخدام هذه الميزة..")
